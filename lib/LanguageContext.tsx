...
const translations: Record<Language, Record<string, string>> = {
    gr: {
        ...
        'booking.postalCode': 'Τ.Κ.',
        'booking.postalCodePlaceholder': 'π.χ. 19009 ή 190 09',
        'booking.postalCodeHelp': 'Δεκτές μορφές: 19009 ή 190 09',
        'booking.postalCodeRequired': 'Ο Τ.Κ. είναι υποχρεωτικός.',
        'booking.postalCodeNumbersOnly': 'Χρησιμοποιήστε μόνο αριθμούς.',
        'booking.postalCodeFiveDigits': 'Ο Τ.Κ. πρέπει να αποτελείται από 5 ψηφία.',
    ...
    en: {
        ...
        'booking.postalCodePlaceholder': 'e.g. 19009 or 190 09',
        'booking.postalCodeHelp': 'Accepted formats: 19009 or 190 09',
        'booking.postalCodeRequired': 'Postal code is required.',
        'booking.postalCodeNumbersOnly': 'Use numbers only.',
        'booking.postalCodeFiveDigits': 'Postal code must contain 5 digits.',
